...
remap_anon: remap_anon.o pmparser.o
	$(CC) -o $@ -no-pie -Wl,--section-start=.remap=0x13370000,--section-start=.writesafe=0x13380000,--section-start=.got.plt=0x500000,--section-start=.data=0x600000 -pthread -static remap_anon.o pmparser.o
